        ...
        <section id="home" className="relative w-full py-12 md:py-14 lg:py-20 xl:py-40 overflow-hidden ">
          ...
          <div className="relative container mx-auto">
            <div className="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-2 lg:gap-16 xl:grid-cols-2 items-center">
              <div className="flex flex-col justify-center items-center space-y-4 md:space-y-8 text-center lg:text-left">
                ...
                <ScrollReveal direction="up" delay={400}>
                  <h1 className="px-2 text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold tracking-tight ">
                ...
                <ScrollReveal direction="up" delay={800}>
                  <div className="flex flex-col sm:flex-row gap-4 md:gap-4 items-center justify-center lg:justify-start px-4 lg:px-0">
                    <Button
                      size="lg"
                ...
                <ScrollReveal direction="up" delay={1000}>
                  <div className="relative overflow-hidden bg-white/30 backdrop-blur-sm rounded-xl md:rounded-2xl border border-white/20 p-2 md:p-6 mx-4 lg:mx-0">
              ...
              <ScrollReveal direction="right" delay={600}>
                <div className="relative order-first lg:order-last px-4 md:px-0">
                  <div
          ...
          <div className="container px-5 md:px-6">
            <ScrollReveal direction="up" delay={200}>
              <div className="flex flex-col items-center justify-center space-y-8 text-center mb-16">
                <Badge variant="outline" className="px-4 py-2 bg-blue-50 rounded-3xl border-blue-200 text-blue-700">
                  Our Services
                </Badge>
            ...
            <StaggeredReveal staggerDelay={200} className="grid gap-8 lg:grid-cols-3 max-w-7xl mx-auto">
              <Card className="relative overflow-hidden border-0 shadow-xl bg-gradient-to-br from-white to-blue-50/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group">
                ...
                <CardHeader className="relative pb-4">
                  ...
                  <CardTitle className="text-xl font-bold text-gray-900">Legionella Testing</CardTitle>
              ...
              <Card className="relative overflow-hidden border-0 shadow-xl bg-gradient-to-br from-white to-cyan-50/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group">
                ...
                <CardHeader className="relative pb-4">
                  ...
                  <CardTitle className="text-xl font-bold text-gray-900">Water System Management</CardTitle>
                  <CardDescription className="text-gray-600 text-base">
            ...
            <div className="grid gap-12 lg:grid-cols-2 max-w-6xl mx-auto items-center">
              <ScrollReveal direction="right" delay={400}>
                <div className="space-y-6 px-4">
                  <h3 className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-blue-900 bg-clip-text text-transparent">Our Mission</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
