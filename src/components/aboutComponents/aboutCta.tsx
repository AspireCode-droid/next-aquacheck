        ...
        <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-4 lg:px-6">
                <div className="text-center">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-800">Ready to Ensure Your Water Safety?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row space-y-6 justify-center mb-12">
